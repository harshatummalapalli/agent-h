...
import { UnipileLinkedInConnectionCard } from "./UnipileLinkedInConnectionCard";
            ...
            <div className="space-y-4 justify-between">
              ...
              <p className="text-sm text-muted-foreground">
                {translate("crm.profile.inbound.description", {
                  _: "You can start sending emails to your server's inbound email address, e.g. by adding it to the Cc: field. TalentCursor will process the emails and add notes to the corresponding contacts.",
                  field: "Cc:",
                })}
              </p>
          ...
          <div className="space-y-4 justify-between">
            ...
            <p className="text-sm text-muted-foreground">
              {translate("crm.profile.mcp.description", {
                _: "Use this URL to connect your AI assistant to your recruiting data via the Model Context Protocol (MCP).",
              })}
            </p>
            <CopyPaste
