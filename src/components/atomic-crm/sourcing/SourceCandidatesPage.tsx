...
export const SourceCandidatesPage = ({
  ...
  // Bulk LinkedIn rate-limiting (E): individual sends are spaced 3s apart
  // because recruiter approves each card separately. handleBulkPrepareOutreach
  // prepares them sequentially; the 3s gap is the natural approval cadence.
