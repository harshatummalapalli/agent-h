...
--
-- Note: handle_new_user() below is Agent H's tenant-aware version (it stamps
-- tenant_id/org_type onto new sales rows). Atomic CRM's original version is
-- superseded -- see 08_agent_h_tenant_foundation.sql for the rationale.
--
...
-- Agent H version: resolves and stamps tenant_id/org_type onto new sales
-- rows at signup. See 08_agent_h_tenant_foundation.sql for full rationale.
