--
-- Grants
-- This file declares Atomic CRM's original grants and default privileges,
-- unmodified. Note: the "alter default privileges ... grant all on tables"
-- statements at the bottom apply automatically to every table created in
-- schema files that load after this one (08 onward) -- see
-- 11_agent_h_event_log.sql for why that matters for the append-only log.
--
